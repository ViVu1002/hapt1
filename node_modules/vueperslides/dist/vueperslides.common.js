...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"7e2444b6-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/pug-plain-loader!./node_modules/vuetify-loader/lib/loader.js!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/vueperslides/vueperslide.vue?vue&type=template&id=427b620c&lang=pug&
var vueperslidevue_type_template_id_427b620c_lang_pug_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c(_vm.link ? 'a' : 'div',{tag:"div",staticClass:"vueperslide",class:_vm.slideClasses,style:(_vm.slideStyles),attrs:{"href":_vm.link && !_vm.justDragged ? _vm.link : false,"face":_vm.slideFace3d,"aria-hidden":_vm.$parent.slides.activeId === _vm._uid || _vm.isSlideVisible ? 'false' : 'true'},on:{"mouseenter":function($event){return _vm.$emit('mouse-enter', { slideIndex: _vm.slideIndex, title: _vm.title, content: _vm.content, image: _vm.image, link: _vm.link }, _vm.$el)},"mouseleave":function($event){return _vm.$emit('mouse-leave')}}},[(_vm.image && _vm.conf.slideImageInside)?_c('div',{staticClass:"vueperslide__image",style:(_vm.imageStyles)}):_vm._e(),_c('div',{directives:[{name:"show",rawName:"v-show",value:(!_vm.conf.slideContentOutside),expression:"!conf.slideContentOutside"}],staticClass:"vueperslide__content-wrapper"},[_vm._t("content",[(_vm.title)?_c('div',{staticClass:"vueperslide__title",domProps:{"innerHTML":_vm._s(_vm.title)}}):_vm._e(),(_vm.content)?_c('div',{staticClass:"vueperslide__content",domProps:{"innerHTML":_vm._s(_vm.content)}}):_vm._e()])],2)])}
var vueperslidevue_type_template_id_427b620c_lang_pug_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/vueperslides/vueperslide.vue?vue&type=template&id=427b620c&lang=pug&
...
/* harmony default export */ var vueperslidevue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    slideStyles: function slideStyles() {
      return _objectSpread({}, !this.conf.slideImageInside && this.image && {
        backgroundImage: "url(\"".concat(this.image, "\")")
      }, {}, this.conf.visibleSlides > 1 && {
        width: 100 / this.conf.visibleSlides + '%'
      }, {}, this.conf.visibleSlides > 1 && this.conf.fade && {
        left: this.slideIndex % this.conf.visibleSlides / this.conf.visibleSlides * 100 + '%'
      });
    },
    ...
    isSlideVisible: function isSlideVisible() {
      ...
      var visibleSlidesCount = this.conf.visibleSlides;
...
var component = normalizeComponent(
  ...
  vueperslidevue_type_template_id_427b620c_lang_pug_render,
  vueperslidevue_type_template_id_427b620c_lang_pug_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var vueperslidesvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    updateCurrentTranslation: function updateCurrentTranslation() {
      ...
      if (this.conf.visibleSlides > 1 && this.conf.slideMultiple === 1) {
        ...
        if (!this.conf.infinite) {
          ...
          var remainingSlides = this.slidesCount - (this.slides.current + 1);
    ...
    goToSlide: function goToSlide(index) {
      ...
      var _this$getSlideInRange2 = this.getSlideInRange(index, autoPlaying),
          ...
          nextSlideIsClone = _this$getSlideInRange2.clone; // If the slide is not found don't go further.


      if (!this.slides.list[nextSlide]) return; // Emit event. First use of `goToSlide` is while init, so should not propagate an event.

      if (this.isReady && !jumping) this.emit('before-slide', true, nextSlide); // Disable arrows if `disableArrowsOnEdges` is on and there is no slide to go to on that end.
    ...
    addSlide: function addSlide(newSlide) {
      this.slides.list.push(newSlide); // If adding the first slide.
  ...
  computed: {
    ...
    trackInnerStyles: function trackInnerStyles() {
      var styles = {}; // Prevent animation if VueperSlides is not yet ready (so that the first clone is not shown before ready).
